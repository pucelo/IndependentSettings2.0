...
public class MiuiColorPickerView extends View {
    private final static int PANEL_SAT_VAL = 0;
    private final static int PANEL_HUE = 1;
    private final static int PANEL_ALPHA = 2;

    private final static float BORDER_WIDTH_PX = 1f;
    private float HUE_PANEL_WIDTH = 30f;
    private float ALPHA_PANEL_HEIGHT = 20f;
    private float PANEL_SPACING = 10f;
    private float PALETTE_CIRCLE_TRACKER_RADIUS = 10f;
    private float RECTANGLE_TRACKER_OFFSET = 5f;
    ...
    public MiuiColorPickerView(Context context) {
        this(context, null);
    }

    public MiuiColorPickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MiuiColorPickerView(Context context, AttributeSet attrs, int defStyle) {
